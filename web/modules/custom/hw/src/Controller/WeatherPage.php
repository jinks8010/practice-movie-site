...
use Drupal\hw\ForecastClientInterface;
use Drupal\Core\Controller\ControllerBase;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Controller for hw.weather_page route.
 */
class WeatherPage extends ControllerBase {
   ...
   * Forecast API client.
   *
   * @var \Drupal\hw\ForecastClientInterface
   */
   ...
   *
   * @param \Drupal\hw\ForecastClientInterface $forecast_client
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      $container->get('hw.forecast_client')
    );
  }
